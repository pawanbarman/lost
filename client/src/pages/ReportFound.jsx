    ...
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-400">
          Help return an item by reporting what you found.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-lg space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 rounded-md focus:ring-sky-500 focus:border-sky-500"
              placeholder="Describe what can be seen (color, type, size)"
            />
          </div>
        </div>
        ...
        <div className="bg-amber-500/10 p-6 rounded-lg border border-amber-400/20 space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-400 mb-2">
              Details only the genuine owner would know. This helps verify claims. NOT shown publicly.
            </p>
            <textarea
              name="privateDetails"
              ...
              rows={3}
              className="w-full px-3 py-2 rounded-md focus:ring-sky-500 focus:border-sky-500"
              placeholder="e.g., Has a blue sticker inside, contains an ID card, specific scratches"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 px-4 bg-green-500/20 text-green-300 rounded-md font-medium hover:bg-green-500/30 border border-green-400/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed"
        >
